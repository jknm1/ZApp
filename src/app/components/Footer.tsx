        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-pink-500 hover:to-rose-600 rounded-xl flex items-center justify-center transition-all group"
                aria-label="Instagram"
              >
                <Instagram className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors" />
              </a>
              <a
                href="https://discord.gg/E3x8gErHB"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-pink-500 hover:to-rose-600 rounded-xl flex items-center justify-center transition-all group"
                aria-label="Discord"
              ...
              <a
                href="mailto:hello@zynxcorp.com"
                className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-pink-500 hover:to-rose-600 rounded-xl flex items-center justify-center transition-all group"
                aria-label="Email"
              >
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ZYNX Capital acquires prop firms, passes their challenges, and recruits elite traders. 
              We vet and interview the best - those who qualify get funded for free. No fees, just pure talent.
            </p>
          </div>
